import { Mesh3, MorphMesh3 } from 'gophergfx'
import { Line3, LineMode3 } from 'gophergfx'
import { Vector3 } from 'gophergfx'
import { Quaternion } from 'gophergfx'
...
export class MyGeometry3Factory
{
    ...
    public static createHouse(): MorphMesh3
    {
        const vertices: number[] = [];
    ...
    public static createCustomMesh(): MorphMesh3
    {
        const vertices: number[] = [];
    ...
    public static createBox(width = 1, height = 1, depth = 1): MorphMesh3
    {
        const vertices: number[] = [];
    ...
    public static createBoxLine(startPoint: Vector3, endPoint: Vector3, thickness: number): MorphMesh3
    {
    ...
    public static createCone(radius = 1, height = 1, numSegments = 8): MorphMesh3
    {
        const vertices: number[] = [];
    ...
    public static createCylinder(numSegments = 20, radius = 1, height = 1): MorphMesh3
    {
        const vertices: number[] = [];
        const normals: number[] = [];
        const indices: number[] = [];
    ...
    public static createPlane(width = 1, height = 1): MorphMesh3
    {
        const vertices: number[] = [];
    ...
    public static createSphere(radius = 1, subdivisions=2): MorphMesh3
    {
