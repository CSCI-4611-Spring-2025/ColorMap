...
// @ts-ignore
import gouraudVertexShader from './shaders/mytriangle.vert'
// @ts-ignore
import gouraudFragmentShader from './shaders/mytriangle.frag'

import * as gfx from 'gophergfx'


export class MyTriangleMaterial extends gfx.Material3
{
    ...
    constructor()
    {
        ...
        MyTriangleMaterial.shader.initialize(this.gl);

        this.kAmbientUniform = MyTriangleMaterial.shader.getUniform(this.gl, 'kAmbient');
        this.kDiffuseUniform = MyTriangleMaterial.shader.getUniform(this.gl, 'kDiffuse');
        this.kSpecularUniform = MyTriangleMaterial.shader.getUniform(this.gl, 'kSpecular');
        this.shininessUniform = MyTriangleMaterial.shader.getUniform(this.gl, 'shininess');

        this.textureUniform = MyTriangleMaterial.shader.getUniform(this.gl, 'surfaceTexture');
        this.useTextureUniform = MyTriangleMaterial.shader.getUniform(this.gl, 'useTexture');

        this.modelUniform = MyTriangleMaterial.shader.getUniform(this.gl, 'modelMatrix');
        this.normalUniform = MyTriangleMaterial.shader.getUniform(this.gl, 'normalMatrix');
        this.viewUniform = MyTriangleMaterial.shader.getUniform(this.gl, 'viewMatrix');
        this.projectionUniform = MyTriangleMaterial.shader.getUniform(this.gl, 'projectionMatrix');

        this.eyePositionWorldUniform = MyTriangleMaterial.shader.getUniform(this.gl, 'eyePositionWorld');
        this.numLightsUniform = MyTriangleMaterial.shader.getUniform(this.gl, 'numLights');
        this.lightTypesUniform = MyTriangleMaterial.shader.getUniform(this.gl, 'lightTypes');
        this.lightPositionsWorldUniform = MyTriangleMaterial.shader.getUniform(this.gl, 'lightPositionsWorld');
        this.ambientIntensitiesUniform = MyTriangleMaterial.shader.getUniform(this.gl, 'lightAmbientIntensities');
        this.diffuseIntensitiesUniform = MyTriangleMaterial.shader.getUniform(this.gl, 'lightDiffuseIntensities');
        this.specularIntensitiesUniform = MyTriangleMaterial.shader.getUniform(this.gl, 'lightSpecularIntensities');

        this.positionAttribute = MyTriangleMaterial.shader.getAttribute(this.gl, 'positionModel');
        this.normalAttribute = MyTriangleMaterial.shader.getAttribute(this.gl, 'normalModel');
        this.colorAttribute = MyTriangleMaterial.shader.getAttribute(this.gl, 'color');
        this.texCoordAttribute = MyTriangleMaterial.shader.getAttribute(this.gl, 'texCoords');   
    }
    ...
    draw(mesh: gfx.Mesh3, camera: gfx.Camera, lightManager: gfx.LightManager): void
    {
        ...
        this.gl.useProgram(MyTriangleMaterial.shader.getProgram());
